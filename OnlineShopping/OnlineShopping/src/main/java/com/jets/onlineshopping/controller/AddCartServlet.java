...
public class AddCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CartItem cItem = new CartItem(new Product(Integer.parseInt(request.getParameter("pId"))),1);
        ...
        System.out.println("cartProducts"+ cartProducts.get(0).getProduct().getId());
        response.sendRedirect("home.html");
        
        /*Testing block*/
        session.setAttribute("logged", new User("12345","4566"));
    }
